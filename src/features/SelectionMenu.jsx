...
const SelectionMenu = (props) => {
	...
	const paramGroupOptions = Object.keys(prodConf[props.menuSelections["selectedProduct"]]["parameters"]).map((grp, i) => ({value:grp, label:grp}))
	const paramOptions = Object.keys(prodConf[props.menuSelections["selectedProduct"]]["parameters"][props.menuSelections["selectedParameterGroup"]]).map(
		(param, j) => (
			{value:param, label: prodConf[props.menuSelections["selectedProduct"]]["parameters"][props.menuSelections["selectedParameterGroup"]][param].label}
		)
	)
	...
	return (
		<div className="m-2 flex w-full max-w-4xl">
